...
KSE100 = [
    ...
    "EFUG", "ENGRO", "ENGROH", "FABL", "FATIMA", "FCCL", "FFC", "FFL", "GADT", "GAL",
    "GATI", "GHGL", "GHNI", "GLAXO", "HALEON", "HASCOL", "HCAR", "HBL", "HGFA", "HINOON",
    "HUBC", "HUMNL", "IBFL", "ILP", "INDU", "INIL", "ISL", "JDWS", "KAPCO", "KEL",
    "KOHC", "KOSM", "KTML", "LCI", "LOTCHEM", "LUCK", "MARI", "MCB", "MEBL", "MEHT",
    "MLCF", "MUREB", "MCB", "NRL", "NATF", "NBP", "NESTLE", "NML", "NPL", "OGDC",
    "PABC", "PAKT", "PAEL", "PGLC", "PIBTL", "PIOC", "PKGS", "POL", "PPL", "PRL",
    "PSEL", "PSO", "PTC", "RMPL", "SCBPL", "SEARL", "SHEL", "SHFA", "SNGP", "SPWL",
    "SSGC", "SYS", "TGL", "THALL", "TPL", "TRG", "UBL", "UPFL", "UNITY", "YOUW"
]
